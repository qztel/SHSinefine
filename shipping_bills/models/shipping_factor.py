...
class ShippingFactor(models.Model):
    ...
    vip_first_weight = fields.Float('VIP首重')
    vip_first_total_price = fields.Float('VIP首重总价')
    vip_next_weight_to_ceil = fields.Float('VIP续重取整')
    vip_next_price_unit = fields.Float('VIP续重单价')
