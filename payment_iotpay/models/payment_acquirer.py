...
class PaymentAcquirer(models.Model):
    ...
    iotpay_notify_url = fields.Char(string='IOTPAY支付回调地址', groups='base.group_system', store=True)
    ...
    def _get_compatible_acquirers(self, *args, currency_id=None, **kwargs):
        ...
        if not website_id and self._context.get('website_id'):
            acquirers = acquirers.filtered(lambda a: a.website_id.id == int(self._context.get('website_id')))
